...
public abstract class BaseError()
{
	...
	/// </summary>
	public abstract uint RawCode { get; }

	/// <summary>
	/// Unknown, labled as RTC in documentation.
	/// </summary>
	public abstract uint Rtc { get; }

	/// <summary>
	/// The raw power state value.
	/// </summary>
	public abstract uint RawPowerState { get; }

	/// <summary>
	/// The raw error state value.
	/// </summary>
	public abstract uint RawBootCause { get; }

	/// <summary>
	/// The raw sequence number value.
	/// </summary>
	public abstract ushort RawSequenceNumber { get; }

	/// <summary>
	/// The raw device power management value.
	/// </summary>
	public abstract ushort RawDevicePowerManagement { get; }

	/// <summary>
	/// The raw chip temperature value.
	/// </summary>
	public abstract ushort RawChipTemperature { get; }

	/// <summary>
	/// The raw environment temperature value.
	/// </summary>
	public abstract ushort RawEnvironmentTemperature { get; }
	...
	protected static string GetErrorCodeDescription(uint errorCode)
	{
	...
	public static implicit operator string(BaseError error) => error.ToString();
	...
	/// </summary>
	protected static readonly Dictionary<ulong, string> _errorCodeDescriptions = new()
	{
	...
	/// </summary>
	protected static readonly Dictionary<uint, string> _secondaryErrorCodeDescriptions = new()
	{
		{ 0x8005, "VRM CPU (2) (?)" },
		{ 0x8006, "VRM GPU(6) (?)" },
	...
	protected static string GetPowerStateDescriptionA(uint powerState)
	{
	...
	/// </summary>
	protected static readonly Dictionary<uint, string> _powerStateDescriptionsA = new() {
		{ 0x00, "SysReady" },
		{ 0x01, "MaOnStby" },
		{ 0x20, "NOR" },
		{ 0x30, "NOR" },
	...
	/// </summary>
	protected static readonly Dictionary<uint, string> _powerStateDesciprtionsSecondaryA = new() {
		//0x10-1F - PSP
		{ 0x10, "PSP" }, 
	...
	/// </summary>
	protected static readonly Dictionary<uint, string> _powerStateDescriptionsB = new() {
	...
	/// </summary>
	protected static readonly Dictionary<uint, string> _bootCauseDescriptions = new()
	{
		{ 0x40000000, "DEV UART" },
	...
	/// </summary>
	protected static readonly Dictionary<uint, string> _sequenceDescriptions = new() {
		{ 0x2002, "EmcBootup" },
		{ 0x2067, "EmcBootup" },
	...
	// Unused padding - also not present in errors retrieved from UART
