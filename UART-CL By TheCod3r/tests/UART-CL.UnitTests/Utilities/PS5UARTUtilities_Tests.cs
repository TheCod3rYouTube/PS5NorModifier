...
namespace UART_CL.UnitTests.Utilities;
...
public class PS5UARTUtilities_Tests
{
    ...
    public void ParseErrors_ValidCode_ShouldReturnDescription()
    {
        File.WriteAllText("errorDB.xml", @"
                <errorCodes><errorCode>
                    <ErrorCode>1234</ErrorCode><Description>Test error</Description></errorCode>
                </errorCodes>");
    ...
    {
        var result = PS5UARTUtilities.PatternAt(new byte[] { 1, 2, 3 },
            Array.Empty<byte>());
        result.Should().BeEmpty();
    }
    ...
    {
        var result = PS5UARTUtilities.PatternAt(new byte[] { 1, 2 },
            new byte[] { 1, 2, 3 });
        result.Should().BeEmpty();
    }
    ...
    {
        var result = PS5UARTUtilities.PatternAt(new byte[] { 1, 2, 3, 4, 5 },
            new byte[] { 3, 4 }
        ).ToList();
    ...
    {
        var result = PS5UARTUtilities.PatternAt(new byte[] { 1, 2, 3, 4, 3, 4 },
            new byte[] { 3, 4 }
        ).ToList();
