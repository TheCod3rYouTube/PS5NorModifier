...
public class SubMenuHelper
{
        ...
        Action<int>? sleep = null)
    {
        ...
        do
        {
            ...
            {
                // Reset the file path so the app does not think that "exit" is the path
                pathToDump = null;
            ...
            else
            {
                ...
                var length = new FileInfo(pathToDump).Length;
        ...
        Func<string>? readLine = null)
    {
        ...
        var lengthBytes = new FileInfo(pathToDump).Length; // File size of the .bin file in bytes
